...
<head>
    ...
    <link rel="icon" href="{{ asset('img/logo-footer.png') }}" type="image/x-icon">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0" style="padding: 10%">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block" style="padding-top: 17%"><center><img class="img-fluid" src="{{ asset('img/register.png') }}"></center></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="{{ route('register.simpan') }}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                        <select name="level" id="level" class="form-control @error('level') is-invalid @enderror" id="exampleInputLevel">
                                            <option selected disabled>-- Silahkan Memilih Level User --</option>
